...
const users = ref([]); // Assuming you have a list of users for the 'Assigned_To' field

const search = () => {
    axios.get('/api/admintasks/search', {
        params: {
...
const deleteTask = () => {
    ...
    axios.delete(`/api/admintasks/${taskIdBeingDeleted.value}`)
    .then(() => {
...
const schema = yup.object({
    ...
    Assigned_To: yup.string().required('Assigned To is required'), // Ensure it's a string or appropriate type
});

const updateTask = (values) => {
    console.log(values);
    axios.put('/api/admintasks/' + formValues.value.id, values)
    .then((response) => {
...
const createTask = (value) => {
    console.log(value);
    axios.post('/api/admintasks', formValues.value)
    .then(response => {
        formValues.value = {
            Task: '',
            Date_Given: '',
...
const getTaskStatus = () => {
    axios.get('/api/admintask-status')
    .then(response => {
...
const getUsers = () => {
    axios.get('/api/users') // Assuming this endpoint returns a list of users
    .then(response => {
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <Field as="select" v-model="formValues.Assigned_To" class="form-control" name="Assigned_To" :class="{'is-invalid': errors.Assigned_To}" id="Assigned_To">
                <option value="">Select Assignee</option>
                <option v-for="user in users" :key="user.id" :value="user.name">{{ user.name }}</option>
            </Field>
            <span class="invalid-feedback">{{ errors.Assigned_To }}</span>
            </div>
            <div class="form-group">
