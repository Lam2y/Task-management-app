    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="/employee/mainpage" class="nav-link">Home</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="https://i.pinimg.com/originals/f8/98/bf/f898bfb34a80f0784e1417c86a096e13.png" class="brand-image img-circle elevation-3" style="opacity: .8;">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <router-link to="/employee/mainpage" class="nav-link">
                        ...
                        <li class="nav-item">
                            <router-link to="/employee/tasks" class="nav-link">
                        ...
                        <li class="nav-item">
                            <router-link to="/employee/timeline" class="nav-link">
